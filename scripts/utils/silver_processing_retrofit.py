...
def process_silver_table(table_name, snapshot_date_str, bronze_dir, silver_dir, spark):
    ...
    if table_name == 'clickstream':
        ...
        # Monthly attributes
        bronze_path = os.path.join(bronze_dir, 'attributes', f'bronze_attr_mthly_{snapshot_date_str.replace("-", "_")}.csv')
        silver_path = os.path.join(silver_dir, 'attributes', f'silver_attributes_mthly_{snapshot_date_str.replace("-", "_")}.parquet')
        ...
        # Monthly financials
        bronze_path = os.path.join(bronze_dir, 'financials', f'bronze_fin_mthly_{snapshot_date_str.replace("-", "_")}.csv')
        silver_path = os.path.join(silver_dir, 'financials', f'silver_financials_mthly_{snapshot_date_str.replace("-", "_")}.parquet')
